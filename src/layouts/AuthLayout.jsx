...
export default function AuthLayout({ headerText, description, children }) {
  return (
    <div className='bg-primary container grid h-screen max-w-none items-center justify-center '>
      <div className='mx-auto flex w-full flex-col justify-center space-y-2 py-8 sm:w-[480px] sm:p-8'>
        <div className='mb-4 flex items-center justify-center'>
          ...
          <h1 className='text-sm md:text-base lg:text-xl font-medium text-background'>
            Developed by{' '}
